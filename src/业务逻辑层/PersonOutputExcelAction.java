...
public class PersonOutputExcelAction extends ActionSupport implements ServletRequestAware, ServletResponseAware{  
    ...
    public String execute() throws Exception {
        ...
        try{  
            ...
            request.setAttribute("filename", "person.xls");//设置文件名  
            return SUCCESS;  
        }catch(Throwable th){  
            th.printStackTrace();  
