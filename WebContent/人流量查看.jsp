...
<html>
	...
	<body>
			...
			<table border="0" width="100%">
				<tr>
					<td colspan="7">
						...
						<a href="downloadPersonAction">下载</a>
					</td>		
				</tr>
			</table>
		</form>
		...
		String sql1="SELECT * from 来访人员  where 离校时间!='尚未离校'";
		String sql2="SELECT * from 来访人员  where 离校时间='尚未离校'";
			...
			<table border="1" width="100%">
		         <tr>
		           ...
		           <td width="10%">
		           		...
		           		<input type="hidden" name="outTime" value=<%=rs.getString(6) %>>
		           </td>
		         </tr>   
	         </table>
		</form>         
